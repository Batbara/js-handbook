...
public class Operator implements org.apache.thrift.TBase<Operator, Operator._Fields>, java.io.Serializable, Cloneable, Comparable<Operator> {
  ...
  private static final org.apache.thrift.protocol.TField OPERATOR_SYMBOL_FIELD_DESC = new org.apache.thrift.protocol.TField("operatorSymbol", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  public java.lang.String operatorSymbol; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ID((short)1, "id"),
    NAME((short)2, "name"),
    OPERATOR_SYMBOL((short)3, "operatorSymbol"),
  ...
  static {
    ...
    tmpMap.put(_Fields.OPERATOR_SYMBOL, new org.apache.thrift.meta_data.FieldMetaData("operatorSymbol", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public Operator(Operator other) {
    ...
    if (other.isSetOperatorSymbol()) {
      this.operatorSymbol = other.operatorSymbol;
    }
  ...
  public Operator setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public Operator setOperatorSymbol(java.lang.String operatorSymbol) {
    this.operatorSymbol = operatorSymbol;
    return this;
  }

  public void unsetOperatorSymbol() {
    this.operatorSymbol = null;
  }

  /** Returns true if field operatorSymbol is set (has been assigned a value) and false otherwise */
  public boolean isSetOperatorSymbol() {
    return this.operatorSymbol != null;
  }

  public void setOperatorSymbolIsSet(boolean value) {
    if (!value) {
      this.operatorSymbol = null;
    }
  }
  ...
  public Operator setDescription(java.lang.String description) {
    this.description = description;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case OPERATOR_SYMBOL:
      if (value == null) {
        ...
        setOperatorSymbol((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(Operator that) {
    ...
    boolean this_present_operatorSymbol = true && this.isSetOperatorSymbol();
    boolean that_present_operatorSymbol = true && that.isSetOperatorSymbol();
    if (this_present_operatorSymbol || that_present_operatorSymbol) {
      if (!(this_present_operatorSymbol && that_present_operatorSymbol))
        return false;
      if (!this.operatorSymbol.equals(that.operatorSymbol))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetOperatorSymbol()) ? 131071 : 524287);
    if (isSetOperatorSymbol())
      hashCode = hashCode * 8191 + operatorSymbol.hashCode();
  ...
  public int compareTo(Operator other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOperatorSymbol()).compareTo(other.isSetOperatorSymbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOperatorSymbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.operatorSymbol, other.operatorSymbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (this.operatorSymbol == null) {
      sb.append("null");
    } else {
      sb.append(this.operatorSymbol);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class OperatorStandardScheme extends org.apache.thrift.scheme.StandardScheme<Operator> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Operator struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // OPERATOR_SYMBOL
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.operatorSymbol = iprot.readString();
              struct.setOperatorSymbolIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Operator struct) throws org.apache.thrift.TException {
      ...
      if (struct.operatorSymbol != null) {
        oprot.writeFieldBegin(OPERATOR_SYMBOL_FIELD_DESC);
        oprot.writeString(struct.operatorSymbol);
        oprot.writeFieldEnd();
      }
